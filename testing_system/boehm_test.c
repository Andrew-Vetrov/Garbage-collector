...
#		else
                  thisNode->left  = gc_calloc(1, sizeof(Node0));
                  thisNode->right = gc_calloc(1, sizeof(Node0));
#		endif
...
static Node MakeTree(int iDepth) {
	Node result;
        if (iDepth<=0) {
#	    ifndef GC
		result = gc_calloc(1, sizeof(Node0));
#	    else
...
#		ifndef GC
                  tempTree = gc_calloc(1, sizeof(Node0));
#		else
...
#	endif
        ...
        printf(" Creating a long-lived binary tree of depth %d\n",
               kLongLivedTreeDepth);
#	ifndef GC
          longLivedTree = gc_calloc(1, sizeof(Node0));
#	else 
...
#	ifndef GC
          array = gc_malloc(kArraySize * sizeof(double));
#	else
#	  ifndef NO_PTRFREE
